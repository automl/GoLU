...
from torchvision.datasets import CIFAR100, CIFAR10, MNIST, KMNIST, FashionMNIST, ImageFolder, ImageNet
try:
...
from tasks.image_classification.tiny_vit.data.augmentation.dataset import IterableImageDataset, ImageDataset
