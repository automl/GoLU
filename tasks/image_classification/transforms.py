"""
The following code has been taken from - https://github.com/pytorch/vision/blob/main/references/classification/transforms.py
"""
...
import torch
from tasks.image_classification.presets import get_module
