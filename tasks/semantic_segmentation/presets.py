"""
The following code has been taken from - https://github.com/pytorch/vision/blob/main/references/segmentation/presets.py
"""
...
def get_modules(use_v2):
    ...
    if use_v2:
        ...
        from tasks.semantic_segmentation import v2_extras

        return torchvision.transforms.v2, torchvision.tv_tensors, v2_extras
    else:
        from tasks.semantic_segmentation import transforms
