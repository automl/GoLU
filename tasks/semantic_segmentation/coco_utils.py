"""
The following code has been taken from - https://github.com/pytorch/vision/blob/main/references/segmentation/coco_utils.py
"""
...
from tasks.semantic_segmentation.transforms import Compose
...
def get_coco(root, image_set, transforms, use_v2=False):
    ...
    if use_v2:
        import tasks.semantic_segmentation.v2_extras as extras
        from torchvision.datasets import wrap_dataset_for_transforms_v2

        transforms = Compose([extras.CocoDetectionToVOCSegmentation(), transforms])
