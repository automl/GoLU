...
architectures_lrs = {
    "resnet34":  [0.2, 0.1, 0.01, 0.001, 0.0001],
    "resnet50":  [0.2, 0.1, 0.01, 0.001, 0.0001],
    "vit_b_32":  [0.1, 0.01, 0.003, 0.001, 0.0001],
    "vit_b_16":  [0.1, 0.01, 0.003, 0.001, 0.0001],
}
...
plot_title_string = 'Test Top-1 Accuracy'
...
for arch, (df_mean, df_stderr) in architecture_dfs.items():
    ...
    plt.tight_layout()
    plt.savefig(f'{root_path}/{arch}.png')
