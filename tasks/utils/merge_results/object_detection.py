...
columns = [
    'Dataset', 'Model', 'Activation', 'Best Test Box MAP', 'Avg Train Loss',
    'Avg Test Box MAP', 'Std Train Loss', 'Std Test Box MAP', 'Avg Training Time (Mins)', 'Avg Inference Time (Mins)',
