...
from tasks.object_detection import presets
import torch
...
from tasks.object_detection import utils
from tasks.object_detection.coco_utils import get_coco
from tasks.object_detection.engine import evaluate, train_one_epoch
from tasks.object_detection.group_by_aspect_ratio import create_aspect_ratio_groups, GroupedBatchSampler
from torchvision.transforms import InterpolationMode
from tasks.object_detection.transforms import SimpleCopyPaste
...
from torchvision.models.detection.faster_rcnn import _resnet_fpn_extractor as frcnn_resnet_fpn_extractor
from torchvision.models.detection.retinanet import _resnet_fpn_extractor as retinanet_resnet_fpn_extractor
from torchvision.models.detection.retinanet import _default_anchorgen, RetinaNetHead
from torchvision.models import resnet50
from torchvision.models.detection import FasterRCNN, RetinaNet, retinanet_resnet50_fpn_v2, fasterrcnn_resnet50_fpn
from functools import partial

from tasks.utils.utils import str_to_bool, load_json, set_seed, save_results, set_worker_sharing_strategy
from golu.activation_utils import replace_activation_by_torch_module
from tasks.utils.plots import save_detection_plots
...
def main(args):
    ...
    if model_name == 'retinanet_resnet50_fpn_v2':
        ...
        backbone = retinanet_resnet_fpn_extractor(
        ...
        state_dict = torch.load(backbone_path, map_location=device)
        backbone.load_state_dict(state_dict['model'])
        backbone = frcnn_resnet_fpn_extractor(backbone, trainable_backbone_layers)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print(
            f'Epoch [{epoch + 1}/{args.epochs}] : Train Loss = {train_loss:.4f} | Test Box MAP = {test_box_map:.4f} | Train Time = {train_time:.2f} mins | Inference Time - {inference_time:.2f} mins'
        )
