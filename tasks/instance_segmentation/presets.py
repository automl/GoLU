"""
The following code has been taken from https://github.com/pytorch/vision/blob/main/references/detection/presets.py
"""

from collections import defaultdict

import torch
import tasks.instance_segmentation.transforms as reference_transforms
